...
export default async function VsBinancePage({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const categories: Array<{
    ...
    {
      category: { en: 'BP Staking Benefits', 'zh-cn': 'BP 质押权益', 'zh-tw': 'BP 質押權益', fr: 'Avantages Staking BP', pt: 'Benefícios Staking BP', it: 'Vantaggi Staking BP', de: 'BP Staking Vorteile', ja: 'BPステーキング特典', ko: 'BP 스테이킹 혜택' },
      backpack: '✅',
      binance: 'BNB',
      winner: 'backpack',
    },
    {
      category: { en: 'Stocks / Securities Beta', 'zh-cn': '股票/证券内测', 'zh-tw': '股票/證券內測', fr: 'Bêta Actions/Titres', pt: 'Beta Ações/Valores', it: 'Beta Azioni/Titoli', de: 'Aktien/Wertpapier-Beta', ja: '株式/証券ベータ', ko: '주식/증권 베타' },
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              ...
              { icon: '🪙', title: { en: 'BP Participant Program', 'zh-cn': 'BP 参与者计划', 'zh-tw': 'BP 參與者計劃', fr: 'Programme BP', pt: 'Programa BP', it: 'Programma BP', de: 'BP Programm', ja: 'BP参加プログラム', ko: 'BP 참여자 프로그램' }, desc: { en: 'BP staking can unlock lower fees, wire perks, equity access, and early product access subject to official terms.', 'zh-cn': 'BP 质押可按官方条款解锁更低费率、wire 优惠、股权入口和新产品优先访问。', 'zh-tw': 'BP 質押可按官方條款解鎖更低費率、wire 優惠、股權入口和新產品優先訪問。', fr: 'Le staking BP peut débloquer frais réduits, wire, equity access et accès anticipé.', pt: 'Staking BP pode liberar taxas menores, wire, equity access e acesso antecipado.', it: 'Lo staking BP può sbloccare fee minori, wire, equity access e accesso anticipato.', de: 'BP Staking kann niedrigere Gebühren, Wire-Vorteile, Equity Access und frühen Produktzugang freischalten.', ja: 'BPステーキングは公式条件に基づき、低手数料、wire特典、株式アクセス、早期製品アクセスを解放できます。', ko: 'BP 스테이킹은 공식 약관에 따라 낮은 수수료, wire 혜택, equity access, 제품 조기 접근을 제공할 수 있습니다.' } },
